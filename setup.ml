...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9ade44a5ae13a31111547d7678172acb) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/modlfo/pla";
          synopsis = "Simple and efficient template library";
          description =
            Some [OASISText.Para "Simple and efficient template library"];
          categories = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pla_ppx"; "Pla_tokens"; "PlaLex"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pla";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "Pla_ppx.ml"});
               Doc
                 ({
                     cs_name = "pla_ppx";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for pla";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "c|e\255N\136\169\192\158\175\004 %\204\n\232";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
